    ...
    <div class="container-fluid py-1 px-3">
      ...
      <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
        ...
        <ul class="navbar-nav  justify-content-end">
         ...
         <li>
          <h6 class="h6">Sistem Informasi Manajemen PT VDU</h6>
         </li>
            ...
            <table class="table align-items-center mt-4 mb-0 table-striped">
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder ">No.Identitas KTP</th>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder ">Nama</th>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder ">Asal Perusahaan</th>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder  ps-2">Tujuan</th>
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder ">Jam Datang</th>
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder ">Jam Pulang</th>
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder ">TTD</th>

                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder " colspan="3">Action</th>
                  </tr>
                </thead>
                <tbody>
                  @php
                  ...
                  <tr>
                    ...
                    <td class="align-middle">
                      <a  class="text-warning font-weight-bold text-xs" href="/quotation/pdf" target="_blank">
